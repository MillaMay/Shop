...
<head>
    ...
    <!-- Для select - добавить связанные товары -->
...
<div class="wrapper">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{--{{asset('adminlte/dist/img/user2-160x160.jpg')}}--}}
                                    {{ asset('images/face.jpg') }}" class="user-image" alt="User Image">
                            <span class="hidden-xs">{{ucfirst (Auth::user()->name) }} </span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="{{ asset('images/face.jpg') }}" class="img-circle" alt="User Image">
                                <p>{{ ucfirst(Auth::user()->name) }}</p>
                            </li>
                            <!-- Menu Footer-->
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{route('users.edit', Auth::user()->id)}}" class="btn btn-default btn-flat">Профиль</a>
                                </div>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="{{ route('home') }}"><i class="fa fa-home"></i><span>В магазин</span></a></li>
                <li><a href="{{ route('index.index') }}"><i class="fa fa-user"></i><span>Главная админки</span></a></li>
                <li>
                    <a href="{{ route('orders.index') }}"><i class="fa fa-shopping-cart"></i><span>Заказы</span></a>
                </li>
                <li class="treeview">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{ route('products.create') }}">Добавить товар</a></li>
                    </ul>
                </li>
                {{--<li>--}}
                    {{--<a href="#"><i class="fa fa-database"></i><span>Кэширование</span></a>--}}
                {{--</li>--}}
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ route('users.index') }}">Список юзеров</a></li>
                        <li><a href="{{ route('users.create') }}">Добавить юзера</a></li>
                    </ul>
                </li>
                <li class="treeview">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ url('admin/filter/groups-filter') }}">Группы фильтров</a></li>
                        <li><a href="{{ url('admin/filter/values-filter') }}">Фильтры</a></li>
                    </ul>
                </li>
            </ul>
            <!-- search form -->
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2020 <span style="color: red">Milla May</span>. All rights reserved.</strong>
    </footer>
...
<script type="text/javascript">
    ...
    $('#search').typeahead ({ // id search указан здесь, чуть выше
...
<script>
    var pathd = '{{PATH}}'; // pathd - указана в public/adminlte/bower_components/ckeditor.config.js
</script>
...
@include('shop.admin.product.include.script_related_product')
