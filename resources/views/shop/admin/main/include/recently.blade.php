<div class="col-md-6">
    ...
    <div class="box box-primary">
                ...
                @foreach($last_products as $product)
                    <li class="item">
                        ...
                        <div class="product-info">
                            <a href="{{ route('products.edit', $product->id) }}" class="product-title">{{ $product->title }}</a>
        ...
        <div class="box-footer clearfix">
            <a href="{{ route('products.index') }}" class="btn btn-sm btn-info btn-flat pull-left">Все продукты</a>
        </div>
        <!-- /.box-footer -->
    </div>
</div>
